...
# # # Inserting sample data into chats collection
# # chat_collection.insert_one({
# #     "user": "John",
# #     "message": "Hello, how are you?",
# #     "timestamp": "2024-09-19T10:15:30"
# # })

# # # Inserting sample data into images collection
# # image_collection.insert_one({
# #     "user": "John",
# #     "image_url": "http://example.com/sample-image.png",
# #     "timestamp": "2024-09-19T10:15:30"
# # })
# # Path to save uploaded images
# UPLOAD_FOLDER = 'C:/Users/anubh/Download/SIH/uploads'
# os.makedirs(UPLOAD_FOLDER, exist_ok=True)
...
#         # 1. Search in corporate data
#         file_paths = [
#             "Backend/Corpus/prd.pdf",
#             "Backend/Corpus/playbook.pdf",
#             "Backend/Corpus/it_support.PDF",
#             "Backend/Corpus/hr.pdf",
#             "Backend/Corpus/corp_events.pdf",
#         ]
#         pages = load_documents(file_paths)
#         text_splitter = RecursiveCharacterTextSplitter(chunk_size=500, chunk_overlap=0)
#         chunks = text_splitter.split_documents(pages)
...
#     app.run(debug=True,port=8081)  # Change the port number if needed
